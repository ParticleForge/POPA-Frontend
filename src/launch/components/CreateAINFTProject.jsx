    ...
    return (
        <div className="w-full h-full">
            <div className="max-w-4xl p-4 mx-auto">
                ...
                <h2 className="text-2xl font-extrabold dark:text-white">Create AI NFT Project</h2>
                <p className="my-4 text-lg font-lato text-gray-500">Create AI NFT Project for your AI Model written in
                ...
                <div className="mb-4 mt-6">
                    <label htmlFor="no_ai_nfts"
                           className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Enter The Maximum No. of AI
                        NFT to Create:</label>
                ...
                <div className="flex justify-center items-center">
                    <button type="button"
                            ...
                            onClick={createAINFT}>
                        {createButtonText}&nbsp;&nbsp;{createButtonText==="Creating Project..."?(<Spinner/>):(<></>)}
                    </button>
                </div>
